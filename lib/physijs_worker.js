    ...
    switch ( description.type ) {
        ...
        case 'box':
            ...
            if ( ( shape = getShapeFromCache( cache_key ) ) === null ) {
                ...
                if (description.collider && description.collider.size) {
                   var size = description.collider.size;
                    _vec3_1.setX(size.x);
                    _vec3_1.setY(size.y);
                    _vec3_1.setZ(size.z);
                }
...
// If there are children then this is a compound shape
    ...
    if (description.collider && description.collider.pos) {
        var pos = description.collider.pos;
        _vec3_2.setX(pos.x);
        _vec3_2.setY(pos.y);
        _vec3_2.setZ(pos.z);
    }
