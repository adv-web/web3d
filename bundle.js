...
// Generated by CoffeeScript 1.12.5
(function() {
  var Component, FirstPersonShooter, GameObject,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
  ...
  FirstPersonShooter = (function(superClass) {
    ...
    function FirstPersonShooter(_scene, _controller, options) {
      this._scene = _scene;
    ...
    FirstPersonShooter.prototype._onFire = function() {
      var currentTime, geometry, material, mesh, rot_x, rot_y, worldPosition;
      ...
      mesh.name = "bullet";
      this._scene.add(new GameObject(mesh));
      rot_y = this._controller._yaw.rotation.y;
      rot_x = this._controller._pitch.rotation.x;
      return mesh.setLinearVelocity(new THREE.Vector3(-Math.sin(rot_y) * Math.cos(rot_x) * this.bullet_speed, Math.sin(rot_x) * this.bullet_speed, -Math.cos(rot_y) * Math.cos(rot_x) * this.bullet_speed));
    };
  ...
  TreeCollider = (function(superClass) {
    ...
    TreeCollider.prototype._onCollision = function(other_mesh, linear_velocity, angular_velocity) {
      if (other_mesh.name === "bullet") {
        this._scene.remove(this.gameObject);
        this._scene.remove(other_mesh);
