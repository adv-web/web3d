...
// Generated by CoffeeScript 1.12.6
(function() {
  var AudioListener, AudioSource, BoxCollider, Bullet, Camera, Data, FirstPersonObserver, FirstPersonShooter, GUIDat, GameObject, HUD, NetWorkComponent, NetWorkTransform, Scene, TreeCollision, VehicleController,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  VehicleController = __webpack_require__(21);
  ...
  TreeCollision = __webpack_require__(20);

  BoxCollider = __webpack_require__(22);
...
(function() {
  ...
  Collider = __webpack_require__(23);
...
function scene1(scene) {
    ...
    NetWorkManager.setUserInfo(document.userInfo, function(data) {
        ...
        for (var i = 0; i < infos.length; i++) {
            inner += "<li>" + infos[i].nickname + "<span>" + infos[i].score + "</span>" + "</li>";
        }
