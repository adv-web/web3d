...
(function() {
  ...
  NetWorkManager = (function() {
    ...
    NetWorkManager._client_onotherjoingame = function(id) {
      var player;
      player = Game.scene.spawn(NetWorkManager.playerPrefab, new THREE.Vector3(0, -0.5, 10));
      player.id = id;
    ...
    NetWorkManager._client_initLocalPlayer = function() {
      ...
      player = Game.scene.spawn(NetWorkManager.playerPrefab, new THREE.Vector3(0, 0.1, 10));
...
// Generated by CoffeeScript 1.12.6
(function() {
  var BoxCollider, Bullet, Camera, Data, FirstPersonController, FirstPersonShooter, GUIDat, GameObject, HUD, NetWorkComponent, NetWorkTransform, Scene, TreeCollision,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  FirstPersonController = __webpack_require__(12);

  FirstPersonShooter = __webpack_require__(13);

  GUIDat = __webpack_require__(14);

  HUD = __webpack_require__(15);

  NetWorkComponent = __webpack_require__(2);

  NetWorkTransform = __webpack_require__(16);

  TreeCollision = __webpack_require__(17);

  BoxCollider = __webpack_require__(18);
...
(function() {
  ...
  Bullet = (function(superClass) {
    ...
    Bullet.prototype.beforeRemoved = function() {
      var ref;
      return (ref = this.gameObject.mesh) != null ? ref.removeEventListener('collision', this._onCollision) : void 0;
    };
...
(function() {
  ...
  Collider = __webpack_require__(19);
...
(function() {
  ...
  Collider = (function(superClass) {
    ...
    Collider.prototype.beforeRemoved = function() {
      return this.gameObject.mesh.removeEventListener('collision', this._onCollision.bind(this));
    };
