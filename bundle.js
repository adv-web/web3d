...
(function() {
  ...
  FirstPersonController = (function(superClass) {
    ...
    function FirstPersonController(options) {
      if (options == null) {
        options = {};
      }
      this.update = bind(this.update, this);
    ...
    FirstPersonController.prototype.onCollision = function(other_mesh, linear_velocity, angular_velocity) {
    ...
    FirstPersonController.prototype.update = function(deltaTime) {
      var distanceH, distanceV, hor, p, ver;
      if (!this.enabled) {
        return;
      }
      if (!this.isLocal) {
      ...
      distanceV = ver * this.move_velocity * deltaTime / 1000;
      distanceH = hor * this.move_velocity * deltaTime / 1000;
...
(function() {
  ...
  FirstPersonShooter = (function(superClass) {
    ...
    FirstPersonShooter.prototype.afterAdded = function() {
      this._controller = this.gameObject.getComponent("FirstPersonController");
