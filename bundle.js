...
// Generated by CoffeeScript 1.12.5
(function() {
  var Bullet, Camera, Data, FirstPersonController, FirstPersonShooter, GUIDatComponent, GameObject, HUD, NetWorkComponent, NetWorkTransformComponent, Scene, TreeCollider,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
(function() {
  ...
  FirstPersonController = (function(superClass) {
    ...
    FirstPersonController.prototype.afterAdded = function() {
      ...
      this.gameObject.mesh.addEventListener('collision', this._onCollision);
