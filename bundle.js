...
(function() {
  ...
  GUIDatComponent = (function(superClass) {
    ...
    GUIDatComponent.prototype.onStartLocalPlayer = function() {
      ...
      return gui.add(nwtm, 'networkSendRate').min(1).max(50).step(1);
    };
...
(function() {
  ...
  TreeCollision = (function(superClass) {
    ...
    TreeCollision.prototype.afterAdded = function() {
      return this.gameObject.mesh.addEventListener('collision', this._onCollision);
    };

    TreeCollision.prototype.beforeRemoved = function() {
      return this.gameObject.mesh.removeEventListener('collision', this._onCollision);
    };

    TreeCollision.prototype._onCollision = function(other_mesh, linear_velocity, angular_velocity) {
