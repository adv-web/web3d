  ...
  NetWorkManager = (function() {
    ...
    NetWorkManager.init = function(server, scene, playerPrefab) {
      ...
      if (!server) {
        ...
        NetWorkManager._initLocalPlayer();
      }
    ...
    NetWorkManager._initLocalPlayer = function() {
      ...
      switch (command) {
        case 's':
          switch (subcommand) {
            ...
            case 'c':
              return NetWorkManager._client_on_otherclientcolorchange(commanddata);
          }
      }
    };
    ...
    NetWorkManager._client_onotherjoingame = function(id) {
      ...
      NetWorkManager.scene.add(player);
      player.id = id;
      NetWorkManager.players.others[data.id] = player;
      return console.log(id + " joined game");
    };

    NetWorkManager._client_onhostgame = function(data) {
      var server_time;
      server_time = parseFloat(data.replace('-', '.'));
      NetWorkManager.local_time = server_time + NetWorkManager.net_latency;
      return NetWorkManager.players.self.host = true;
    };

    NetWorkManager._client_onjoingame = function(data) {
...
(function() {
  ...
  ExplodeAnimation = __webpack_require__(12);
...
GameCore.prototype.start = function () {
    ...
    var FirstPersonController = __webpack_require__(6);
    var HUD = __webpack_require__(8);
    var FirstPersonShooter = __webpack_require__(7);
    var TreeCollider = __webpack_require__(9);
        // 公用资源
