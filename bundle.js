...
(function() {
  ...
  NetWorkManager = (function() {
    ...
    NetWorkManager.server_add_player = function(player) {
      var comp, key, playerObject, ref, results;
      ...
      for (key in ref) {
        ...
        results.push(typeof comp.onStartServerPlayer === "function" ? comp.onStartServerPlayer(player) : void 0);
      }
      return results;
    };
...
(function() {
  ...
  GameObject = __webpack_require__(3);
...
(function() {
  ...
  NetWorkTransformComponent = (function(superClass) {
    ...
    NetWorkTransformComponent.prototype.onStartLocalPlayer = function() {
      ...
      setInterval(networkSend, this.networkSendRate);
...
GameCore.prototype.server_start = function() {
    ...
    function player() {
        ...
        var NetWorkTransformComponent = __webpack_require__(11);
...
GameCore.prototype.start = function () {
    ...
    var FirstPersonController = __webpack_require__(7);
    var HUD = __webpack_require__(10);
    var FirstPersonShooter = __webpack_require__(8);
    ...
    function scene1(scene) {
        ...
        function player() {
            ...
            var GUIDatComponent = __webpack_require__(9);
